...
<script type="text/javascript" src="back/js/listKsc.js"></script>
	...
	<form enctype="multipart/form-data" method="post" name="messageForm"
		...
		<table width="100%" border="1" cellpadding="0">
			...
			<tr>
				...
				<td><input type="text" value="" name="kid" id="kid"
					readonly="readonly" />
				</td>
			</tr>
			
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>歌曲歌名&nbsp;</td>
				<td><input type="text" value="" name="songName" id="songName" />
				</td>
			</tr>

			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>歌手名称&nbsp;</td>
				<td><input type="text" value="" name="artist" id="artist" /></td>
			</tr>

			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>ksc文件&nbsp;</td>
				<td><input accept='.ksc' type="file" name="file" id="file"
					value="" />
				</td>
			</tr>
