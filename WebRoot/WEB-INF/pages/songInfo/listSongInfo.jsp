...
<script type="text/javascript" src="back/js/listSongInfo.js"></script>
...
<div id="win" class="easyui-window" title="编辑"
	...
	<form enctype="multipart/form-data" method="post" name="messageForm"
		...
		<table width="100%" border="1" cellpadding="0">
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>歌曲名称&nbsp;</td>
				<td><input type="text" value="" name="title" id="title" /></td>
			</tr>
			
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>歌手名称&nbsp;</td>
				<td><input type="text" value="" name="singer" id="singer" /></td>
			</tr>
			
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>关键字&nbsp;</td>
				<td><input type="text" value="" name="key" id="key" /></td>
			</tr>
			

			<tr>
				<td height="25px" align='right' nowrap>mp3文件&nbsp;</td>
				<td><input accept='.mp3' type="file" name="file" id="file"
					value="" />
				</td>
			</tr>
