...
<script type="text/javascript" src="back/js/addSongInfo.js"></script>
	...
	<form enctype="multipart/form-data" method="post" name="messageForm"
		...
		<table width="100%" border="1" cellpadding="0">
			...
			<tr>
				...
				<td><input type="text" value="" name="key" id="key" />
				</td>
			</tr>


			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>mp3文件&nbsp;</td>
