...
<script type="text/javascript" src="back/js/listEasyTouchTheme.js"></script>
...
<div id="win" class="easyui-window" title="编辑"
	...
	<form enctype="multipart/form-data" method="post" name="messageForm"
		...
		<table width="100%" border="1" cellpadding="0">
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>主题名称&nbsp;</td>
				<td><input type="text" value="" name="themeName" id="themeName" />
				</td>
			</tr>

			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>预览图片文件&nbsp;</td>
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>皮肤文件&nbsp;</td>
				<td><input accept='.zip' type="file" name="skinfile"
					id="skinfile" value="" /></td>
			</tr>
			<tr style="padding:5px;text-align:center;">
				<td></td>
				<td height=35><input type="button" value="保存"
					onClick="javascript:save()" /> &nbsp;&nbsp;<input type="button"
					value="取消 " onClick="javascript:cancel()" />
				</td>
			</tr>
		</table>
