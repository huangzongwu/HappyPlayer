...
<script type="text/javascript" src="back/js/addEasyTouchTheme.js"></script>
	...
	<form enctype="multipart/form-data" method="post" name="messageForm"
		...
		<table width="100%" border="1" cellpadding="0">
			...
			<tr>
				...
				<td><input type="text" value="" name="themeName" id="themeName" /></td>
			</tr>
			...
			<tr>
				...
				<td><input accept='.zip' type="file" name="skinfile" id="skinfile"
					value="" />
				</td>
			</tr>
