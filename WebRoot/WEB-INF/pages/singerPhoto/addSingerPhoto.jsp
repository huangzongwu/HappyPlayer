...
<script type="text/javascript" src="back/js/addSingerPhoto.js"></script>
...
<body class="easyui-layout" style=" overflow:scroll">
	<form enctype="multipart/form-data" method="post" name="messageForm"
		...
		<table width="100%" border="1" cellpadding="0">
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>选择歌手写真图片1&nbsp;</td>
				<td><input accept="image/*" type="file" name="file1" id="file1"
					onchange="readFile1(this.files[0])" value="" /></td>
			</tr>

			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000"></font>图片1预览&nbsp;</td>
				<td><div id="result1"></div>
				</td>
			</tr>
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>选择歌手写真图片2&nbsp;</td>
				<td><input accept="image/*" type="file" name="file2" id="file2"
					onchange="readFile2(this.files[0])" value="" /></td>
			</tr>

			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000"></font>图片2预览&nbsp;</td>
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>选择歌手写真图片3&nbsp;</td>
				<td><input accept="image/*" type="file" name="file3" id="file3"
					onchange="readFile3(this.files[0])" value="" /></td>
			</tr>

			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000"></font>图片3预览&nbsp;</td>
				<td><div id="result3"></div>
				</td>
			</tr>
