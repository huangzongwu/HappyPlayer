...
<script type="text/javascript" src="back/js/addAPP.js"></script>
...
<body class="easyui-layout" style="overflow-y: hidden" scroll="no">
	<form enctype="multipart/form-data" method="post" name="messageForm"
		...
		<table width="100%" border="1" cellpadding="0">
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>名称&nbsp;</td>
			...
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>版本名&nbsp;</td>
				<td><input type="text" value="" name="versionName" id="versionName" /></td>
			</tr>
			
			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>版本号&nbsp;</td>
				<td><input type="text" value="" name="versionCode" id="versionCode" /></td>
			</tr>
			

			<tr>
				<td height="25px" align='right' nowrap><font color="#FF0000">*</font>apk文件&nbsp;</td>
				<td><input accept='.apk' type="file" name="file" id="file"
					value="" />
				</td>
			</tr>
			...
			<tr>
				...
				<td height=35><input type="button" value="添加 "
					onClick="javascript:submitMessageForm()" />
				</td>
			</tr>
		</table>
