			...
			.datagrid(
					{
						...
						url : 'skinTheme_list.action', // 服务器地址,返回json格式数据
						nowrap : true,
						autoRowHeight : false,
						striped : true,
						collapsible : true,
...
function readFile() {
	...
	if (file == 'undefined' || file == null) {
		result.innerHTML = '<img  height="300" width="200" src="phone/getSkinThemePreviewImageByID?sd='
				+ imageId + '" alt=""/>';
 ...
 * @param sid
 */
function loadSkinThemeDetail(sid) {
	$
			.ajax({
				url : 'skinTheme_getSkinThemeByID.action',
				data : 'sid=' + sid,
				error : function() {
				...
				success : function(data) {
					if (data === 'undefined' || data == null) {
						...
						document.getElementById("result").innerHTML = '<img  height="300" width="200" src="phone/getSkinThemePreviewImageByID?sid='
								+ data.sid + '" alt=""/>';
					}
				}
			});
