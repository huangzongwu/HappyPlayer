			...
			.datagrid(
					{
						...
						url : 'singerAvatar_list.action', // 服务器地址,返回json格式数据
						nowrap : true,
						autoRowHeight : false,
						striped : true,
						collapsible : true,
 ...
 * @param sid
 */
function loadSingerAvatarDetail(sid) {
	$
			.ajax({
				url : 'singerAvatar_getSingerAvatarByID',
				data : 'sid=' + sid,
				error : function() {
				...
				success : function(data) {
					if (data === 'undefined' || data == null) {
						...
						document.getElementById("result").innerHTML = '<img  height="300" width="200" src="phone/getSingerAvatarImageByID?sid='
								+ data.sid + '" alt=""/>';
					}
				}
			});
